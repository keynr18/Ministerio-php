...
<?php 
 ...
 ?>
<form class="container" method="POST" class="" id="formPro" action="?url=controladorActualizarproduccion-admin&ci=<?php echo $cedula; ?>" name="" enctype="application/x-wwww-urlencoded">
  ...
  <label type="hidden" name="id">
      ...
      <div class="row justify-content-center mt-2">
          ...
          <a href="?url=controlador-buscar-productorr&ci=<?php echo $cedula; ?>"><button class="btn btn-danger mb-3 ml-1">Atrás</button></a>
      </div>
