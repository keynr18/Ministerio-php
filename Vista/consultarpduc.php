...
<div class="container border mt-5">
  ...
  <form class="container" method="get" class="" id="formPro" action="" name="" enctype="application/x-wwww-urlencoded">
     ...
     <h2 class="display-4 text-center">consultar producción</h2>
      ...
      <div class="row">
           ...
           <label class="col-lg-6 text-center"><p class="btn-danger pt-2 pb-2">Grupo agricola</p>
             <input type="text"  name="" id="" placeholder="Grupo" class="form-control">
           </label> 

           <label class="col-lg-6 text-center"><p class="btn-danger pt-2 pb-2">Cultivo</p>
             <input type="text"  name="" id="" placeholder="Cultivo" class="form-control">
           </label> 

      </div>

      <div class="row justify-content-center mt-2">
          <button type="" id="" class="btn btn-danger mb-3 ml-1"><a href="respuestapduc.php">Consultar</button>
