...
function validar(){
    ...
    if (nombre.value=="") {
       ...
       // alert("el campo nombre es necesario");
        ...
        toastr.options = {
         ...
         toastr["error"]('Nombre entre 3 y 40');
     ...
     // validacion apellido
        ...
        toastr["error"]('Apellido entre 3 y 40');
     ...
     // validacion cedula
        ...
        toastr["error"]("Cedula entre 7 y 8 digitos");
    ...
    // validacion telefono
        ...
        toastr["error"]("Selecciona el numero de linea de telefono");
       ...
       // alert("el campo telefono es necesario");
        ...
        toastr["error"]("telefono 11 digitos");
   ...
   //     alert("el campo usuario es necesario");
        ...
        toastr["error"]("Usuario entre 5 y 10");
   ...
   //     alert("el campo contraseña es necesario");
        ...
        toastr["error"]("Contraseña entre 5 y 10");
...
//        alert("Es necesario rectificar contraseña");
  ...
  //      alert("No coninciden las contraseñas");
    ...
    if (verificar==true){
        ...
        if (confirm('tus datos seran actualizados, deberas iniciar session de nuevo.')) {
