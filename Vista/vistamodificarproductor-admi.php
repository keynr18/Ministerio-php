...
<article class="container mt- pt-3">
      <p class="display-4 text-center mt-">Actualizar Productor</p>
</article>

<?php 


require_once 'Controlador/controlador-mostrarmodificar-admin.php';
...
<div class='container mt-2'>
      ...
      <div class='row justify-content-center'>
        <div class='col-sm-11 col-lg-8 borde bg-success'>
          ...
          <form for='' action='?url=controladormodificarproductor-admi' method='post' enctype='application/x-wwww-urlencoded'  name='form' id='formulario' class='formulario'>
            ...
            <hr>
             ...
             <hr>
              ...
              <div class='d-flex justify-content-center'>
                 ...
                 <div class='form-group'>
                  <a href='?url=controlador-buscar-productorr&ci={$r["cedula_p"]}'><button type='button' class='btn btn-danger ml-2'>Atrás</button></a>
                 </div>
                </div>
          </form>
        </div>
...
<!--fin del formulario de registro-->
  <footer class="contaier-fluid mt-3 h-25 pb-5 bg-success">
    ...
    <script type="text/javascript" src="Vista/js/validaralmodificaradmin.js"></script>
