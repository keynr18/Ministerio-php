...
foreach ($busqueda2 as $resul) {

  $pdf->cell(30,10,$resul['nombre_h'],1,0,'C,',0);
  $pdf->cell(30,10,$resul['direccion_h'],1,0,'C,',0);
  $pdf->cell(30,10,$resul['telefono_h'],1,0,'C,',0);
  $pdf->cell(30,10,$resul['hectaria'],1,0,'C,',0);
  $pdf->cell(40,10,$resul['nombre_parroquia'],1,1,'C,',0);
}
